      ...
      <div class="w-full px-2 md:px-20 p-10 md:py-20 flex flex-col items-center gap-16" id="insights">
        ...
        <div class="w-full flex flex-row justify-between flex-wrap">
          <div class="w-full md:w-3/5 information-form-div flex flex-col gap-7 order-2 md:order-1">
            ...
            <form method="post" action="enganementLetter.php" class="information-form py-5 px-2 md:px-9 flex flex-col gap-5" id="privacy-agreement">
              ...
              <input type="text" name="name" class="information-secondary-field w-full" value="<?php echo $name ?>" placeholder="Full Name*" required/>
              <fieldset>
                <div>
