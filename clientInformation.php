    ...
    <div class="w-full px-1 md:px-20 py-20 flex flex-col items-center gap-16" id="insights">
      ...
      <div class="w-full flex flex-row justify-between flex-wrap">
        <div class="w-full md:w-3/5 information-form-div flex flex-col gap-7 order-2 md:order-1">
          <form method="post" action="privacyAgreement.php" class="information-form py-5 px-9 flex flex-col gap-1.5 md:gap-5"
            id="clientForm">
            ...
            <div class="form-fields-div flex-wrap gap-y-1.5">
              <input type="text" name="city" id="city" required class="information-secondary-field w-full md:w-[49%]" placeholder="City" />
              <input type="text" name="state" id="state" required class="information-secondary-field w-full md:w-[49%]"
                placeholder="State/ Province" />
            </div>
            <div class="form-fields-div flex-wrap gap-y-1.5">
              <input type="text" name="postalCode" id="postalCode" required class="information-secondary-field w-full md:w-[49%]"
                placeholder="Postal Code" />
              <input type="text" id="country" name="country" required class="information-secondary-field w-full md:w-[49%]"
                placeholder="Country" />
            </div>
            <div class="form-fields-div flex-wrap gap-y-1.5">
              <input type="text" id="citizenshipStatus" name="citizenshipStatus" required class="information-secondary-field w-full md:w-[49%]"
                placeholder="Citizenship Status" />
              <input type="text" id="countryOfCitizenship" name="countryOfCitizenship" required class="information-secondary-field w-full md:w-[49%]"
